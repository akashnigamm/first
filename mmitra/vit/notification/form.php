...
<!-- we ha ve to c-->
    <form name="enc"  action="form.php" method="post"  >
        ...
        phno=<input type="number" name="number"/><br/>
        <input type="submit"   value="Submit"/>
    </form>
    <?php
	if((isset($_POST["name"])&&isset($_POST["name"]))==1)
	{
try
{
...
system('C:\/Python34\/python.exe  C:\/wamp\/www\/mmitra\/vit\/notification\/pytho\/nigam.py '.$t,$res);
